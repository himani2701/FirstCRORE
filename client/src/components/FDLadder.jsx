  ...
  return (
    <div className="booking-section">
      <div className="booking-card">
        <div className="booking-blostem-badge">
          <span>Powered by</span>
          <strong>Blostem</strong>
          <span className="blostem-sub">Multi-bank FD infrastructure</span>
        </div>
        <div className="booking-content">
          <h3>Ready to actually do this?</h3>
          <p className="text-muted">
            In production, one tap routes your FD booking to the right bank via Blostem's API —
            handling KYC, rate lock, and confirmation in seconds. You never see the infrastructure.
            You just see it work.
          </p>
        </div>
        {!clicked ? (
          <button className="btn btn-primary booking-btn" onClick={() => setClicked(true)}>
            Book via Blostem (demo) →
          </button>
        ) : (
          <div className="booking-success">
            <span className="success-icon">✅</span>
            <div>
              <strong>Booking initiated!</strong>
              <p className="text-muted" style={{ fontSize: "0.85rem" }}>
                In production: Blostem API routes this to your chosen banks, KYC is verified,
                and you get a confirmation within 60 seconds.
              </p>
            </div>
          </div>
        )}
